...
Citizen.CreateThread( function()
    PerformHttpRequest("https://raw.githubusercontent.com/Niknock/NKHD_Cartridges_V2/main/version", checkVersion, "GET")
end)